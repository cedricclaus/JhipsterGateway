...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/entity-1'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Entity1) {
        return item.id;
    }
    registerChangeInEntity1S() {
        this.eventSubscriber = this.eventManager.subscribe('entity1ListModification', (response) => this.loadAll());
    }
