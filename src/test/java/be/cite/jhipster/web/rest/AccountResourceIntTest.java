...
import be.cite.jhipster.GatewayApp;
import be.cite.jhipster.domain.Authority;
import be.cite.jhipster.domain.User;
import be.cite.jhipster.repository.AuthorityRepository;
import be.cite.jhipster.repository.UserRepository;
import be.cite.jhipster.security.AuthoritiesConstants;
import be.cite.jhipster.service.MailService;
import be.cite.jhipster.service.UserService;
import be.cite.jhipster.service.dto.UserDTO;
import be.cite.jhipster.web.rest.vm.KeyAndPasswordVM;
import be.cite.jhipster.web.rest.vm.ManagedUserVM;
