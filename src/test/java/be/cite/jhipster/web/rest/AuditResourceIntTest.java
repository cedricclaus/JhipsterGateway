...
import be.cite.jhipster.config.audit.AuditEventConverter;
import be.cite.jhipster.domain.PersistentAuditEvent;
import be.cite.jhipster.repository.PersistenceAuditEventRepository;
import be.cite.jhipster.service.AuditEventService;
